...
r"""This module defines the entrypoint for the PythonExecutorOperator in Tflex.

This library is intended to serve as the entrypoint for a binary that packages
the python executors in a pipeline. The resulting binary is called by the Tflex
